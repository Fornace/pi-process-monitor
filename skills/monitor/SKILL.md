...
user-invokable: true
tested_date: 2026-08-12
tested_with: pi-process-monitor 2.0.1, @earendil-works/pi-coding-agent 0.80.2+
---
...
4. Provide exactly one source: `command`, `logFile`, or `probe`. Omit the other two fields entirely. Version 2.0.1 also removes empty source placeholders generated by compatible clients before validation when one real source is present.
