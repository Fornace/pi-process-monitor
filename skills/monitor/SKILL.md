...
tested_with: pi-process-monitor 1.2.0, @earendil-works/pi-coding-agent (peer)
---
...
modes. Also available as `--timeout N` in the `/monitor` command. Survives
restart-resume for poll/file watchers.
